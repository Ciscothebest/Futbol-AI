...
-- --- TABLA: teams (columnas de estad�sticas de liga) --------------------------
-- Agregadas el 2026-08-04 - faltaban en producci�n
...
-- Sincronizacion 2026-08-04: campos faltantes en produccion
ALTER TABLE "Prospects" ADD COLUMN IF NOT EXISTS category VARCHAR(50);
ALTER TABLE leagues ADD COLUMN IF NOT EXISTS "leagueCode" VARCHAR(100);
ALTER TABLE payments ADD COLUMN IF NOT EXISTS "userEmail" VARCHAR(150);
ALTER TABLE payments ADD COLUMN IF NOT EXISTS "pdfUrl"    VARCHAR(500);
